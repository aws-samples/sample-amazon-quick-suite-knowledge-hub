...
def get_region():
    return boto3.Session().region_name or os.environ.get(
...
TOOL_LAMBDAS = [
    (
        "hr-gw-get-payroll",
        "get_payroll_info.py",
        "Get employee payroll and compensation",
    ),
    (
        "hr-gw-get-org-chart",
        "get_org_chart.py",
        "Get org chart and reporting structure",
    ),
