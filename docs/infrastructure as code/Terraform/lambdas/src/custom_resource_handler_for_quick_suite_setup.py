...
class QuickSuiteSetup:
    ...
    def create_quicksight_subscription(self, account_name: str, admin_email: str) -> dict:
    ...
    def create_quicksight_service_role(self) -> dict:
        ...
        try:
            ...
            response = self.iam.create_role(
                ...
                Tags=[
                    {'Key': 'ManagedBy', 'Value': 'QuickSuiteStarterKit'}
                ]
            )
...
def handler(event, context):
    ...
    try:
        if request_type == 'Create' or request_type == 'Update':
            ...
            result = {'status': 'SKIPPED', 'message': f'Unknown request type: {request_type}'}
