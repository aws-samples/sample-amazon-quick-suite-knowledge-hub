...
exports.handler = async (event) => {
  try {
    ...
    return {
      statusCode: 200,
      body: JSON.stringify({ message: "Data seeded", count: items.length }),
    };
  } catch (error) {
...
function buildFinanceData() {
  ...
  for (const m of months) {
    ...
    const ts = new Date(
      `${m.year}-${String((months.indexOf(m) % 12) + 1).padStart(2, "0")}-01`,
    ).getTime();
  ...
  const countries = [
    {
      ...
      region: "North America",
      revenue2024Q3: 2650000,
      revenue2024Q2: 2780000,
      growth: -4.7,
    },
    {
      country: "United Kingdom",
      region: "EMEA",
      revenue2024Q3: 520000,
      revenue2024Q2: 580000,
      growth: -10.3,
    },
    {
      country: "Germany",
      region: "EMEA",
      revenue2024Q3: 480000,
      revenue2024Q2: 510000,
      growth: -5.9,
    },
    {
      country: "France",
      region: "EMEA",
      revenue2024Q3: 320000,
      revenue2024Q2: 340000,
      growth: -5.9,
    },
    {
      country: "Japan",
      region: "APAC",
      revenue2024Q3: 380000,
      revenue2024Q2: 400000,
      growth: -5.0,
    },
    {
      country: "Australia",
      region: "APAC",
      revenue2024Q3: 290000,
      revenue2024Q2: 270000,
      growth: 7.4,
    },
    {
      country: "India",
      region: "APAC",
      revenue2024Q3: 240000,
      revenue2024Q2: 210000,
      growth: 14.3,
    },
    {
      country: "Singapore",
      region: "APAC",
      revenue2024Q3: 130000,
      revenue2024Q2: 110000,
      growth: 18.2,
    },
    {
      country: "Brazil",
    ...
    },
    {
      country: "Mexico",
      region: "LATAM",
      revenue2024Q3: 160000,
      revenue2024Q2: 180000,
      growth: -11.1,
    },
    {
      country: "Canada",
      region: "North America",
      revenue2024Q3: 330000,
      revenue2024Q2: 310000,
      growth: 6.5,
    },
  ];
