    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        database = glue.CfnDatabase(
            ...
            database_input=glue.CfnDatabase.DatabaseInputProperty(
                name="genai_ops_db", description="Database for Bedrock invocation logs"
            ),
        )
            ...
            table_input=glue.CfnTable.TableInputProperty(
                ...
                storage_descriptor=glue.CfnTable.StorageDescriptorProperty(
                    columns=[
                        ...
                        glue.CfnTable.ColumnProperty(
                            name="input",
                            type="struct<inputContentType:string,inputBodyJson:struct<messages:array<struct<role:string,content:array<struct<text:string>>>>,system:array<struct<text:string>>,inferenceConfig:struct<maxTokens:int,temperature:double,topP:double>>,inputTokenCount:int>",
                        ),
                        glue.CfnTable.ColumnProperty(
                            name="output",
                            type="struct<outputContentType:string,outputBodyJson:struct<output:struct<message:struct<role:string,content:array<struct<text:string>>>>,stopReason:string,metrics:struct<latencyMs:int>,usage:struct<inputTokens:int,outputTokens:int,totalTokens:int>>,outputTokenCount:int>",
                        ),
                    ],
