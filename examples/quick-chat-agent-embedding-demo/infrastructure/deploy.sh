...
echo "🚀 Starting QuickChat Embedding Demo deployment..."

# Check for custom allowed domains
ALLOWED_DOMAINS=${1:-"http://localhost:3000,https://localhost:3000"}
echo "📋 Using allowed domains: $ALLOWED_DOMAINS"
...
echo "✅ Generated .env.local file with actual values:"
...
echo ""
echo "💡 To deploy with custom domains:"
