...
export default function Home() {
  ...
  const handleSignIn = () => {
    const authUrl =
      `${cognitoConfig.domain}/oauth2/authorize?` +
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
                Experience Quick&apos;s chat agent embedded directly into your application. This
                demo showcases how to integrate conversational capabilities that provide contextual
                responses within your existing workflow.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-aws-gray py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Sign in with your Cognito credentials to experience Quick&apos;s embedded chat
              capabilities.
            </p>
            <button
              onClick={handleSignIn}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
                ...
                <h3 className="text-xl font-semibold text-aws-dark-blue mb-3">
                  Unified Chat Experience
                </h3>
                <p className="text-gray-600">
                  Seamlessly integrate structured and unstructured data conversations into your
                  applications.
                </p>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
                ...
                <p className="text-gray-600">
                  Designed with access controls and data governance for enterprise applications.
                </p>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
                ...
                <p className="text-gray-600">
                  Customize visual theming and conversational tone to match your company&apos;s
                  brand identity.
                </p>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
                ...
                <p className="text-gray-600">
                  Connect to 40+ data sources and integrate with tools like Slack, Jira, and
                  SharePoint.
                </p>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
                ...
                <p className="text-gray-600">
                  Seamless integration with your existing enterprise authentication infrastructure.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-8">
                For more detailed information about the Quick SDK and experience-specific options,
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {idToken && apiEndpoint && <ChatPopup idToken={idToken} apiEndpoint={apiEndpoint} />}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Experience the embedded chat interface. Click the chat button in the bottom right
              corner to start a conversation with the chat assistant.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-white border border-gray-200 rounded-lg p-8 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Experience embedded chat capabilities through natural language conversations and
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-8 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                See how Amazon Quick chat seamlessly integrates into web applications using the
                embedding SDK.
              </p>
            </div>
          </div>
