...
export default function ChatPopup({ idToken, apiEndpoint }: ChatPopupProps) {
  ...
  const callEmbeddingAPI = async (token: string): Promise<ApiResponse> => {
    ...
    if (
      data.status === "Exception: InvalidGrantException:  (Code: InvalidGrantException)" ||
            ...
            agentOptions: {
              fixedAgentId: (() => {
                ...
                if (!agentId || agentId === "REPLACE_WITH_YOUR_AGENT_ID") {
                  throw new Error(
                    "NEXT_PUBLIC_QUICKSUITE_AGENT_ID is not configured. Please update your .env.local file with your QuickSuite agent ID. See README.md for instructions.",
                  );
                }
                return agentId;
              })(),
        ...
        >
          ...
          <div
            className={`flex items-center justify-between p-4 bg-gradient-to-r from-purple-600 to-blue-600 text-white transition-all duration-300 ${
              isMinimized
                ? "rounded-2xl cursor-pointer hover:from-purple-700 hover:to-blue-700"
                : "border-b border-purple-500/20 rounded-t-2xl"
            }`}
          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                {!isMinimized && (
                  <p className="text-xs text-purple-100 opacity-90">Embedded chat interface</p>
                )}
              </div>
            </div>
              ...
              <div className="h-full flex flex-col items-center justify-center p-6 bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50 relative overflow-hidden">
                ...
                <div className="relative z-10 text-center mb-6">
                  ...
                  <h2 className="text-xl font-semibold text-gray-800 mb-2">
                    Welcome to the Embedded Chat Demo!
                  </h2>
                  <p className="text-gray-600 text-sm leading-relaxed max-w-sm">
                    This demonstrates how embedded chat can be integrated into your applications.
                    Try asking questions to see how it works:
                  </p>
                </div>
