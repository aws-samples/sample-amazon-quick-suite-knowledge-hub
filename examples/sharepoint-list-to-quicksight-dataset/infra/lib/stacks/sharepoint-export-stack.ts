...
import { SharePointExportConfig, createConstructId, getRemovalPolicy } from "../common/config";
...
export class SharePointExportStack extends Stack {
  constructor(scope: Construct, id: string, { config, ...props }: SharePointExportStackProps) {
    super(scope, id, props);

    const { projectName, retainResources, entraTenantId, entraClientId } = config;
    ...
    const storage = new StorageBuckets(this, createConstructId("Storage"), {
      projectName,
      removalPolicy,
      retainResources,
      account,
    ...
    const entraClientSecret = new Secret(this, createConstructId("EntraClientSecret"), {
      secretName: `${projectName}/entra-client-secret`,
      description: "Entra app client secret for OBO token exchange",
      removalPolicy,
    });

    const apiGateway = new ApiGatewayLambda(this, createConstructId("Api"), {
      projectName,
          ...
          paths: {
            "/sites": {
              get: {
                ...
                responses: {
                  "200": {
                    description: "Matching sites",
                    content: {
                      "application/json": {
                        schema: { type: "object", properties: { sites: { type: "object" } } },
                      },
                    },
                  },
                },
            ...
            "/sites/{site_id}/lists": {
              get: {
                ...
                responses: {
                  "200": {
                    description: "Lists in the site",
                    content: {
                      "application/json": {
                        schema: { type: "object", properties: { lists: { type: "object" } } },
                      },
                    },
                  },
                },
                      ...
                      "application/json": {
                        schema: {
                          ...
                          properties: {
                            ...
                            csv_s3_key: { type: "string" },
                            manifest_s3_key: { type: "string" },
                  ...
                  authorizationCode: {
                    ...
                    scopes: {
                      [`api://${entraClientId}/access_as_user`]:
                        "Access SharePoint data on behalf of the user",
                    },
                  },
                },
              },
